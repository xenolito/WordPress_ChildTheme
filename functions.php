<?php
function pictau_child_enqueue_styles() {
	// enqueue parent style.css
	wp_enqueue_style('pictau', get_template_directory_uri() .'/style.css');
	// enqueue child styles
	wp_enqueue_style('pictau-child', get_stylesheet_directory_uri() .'/style.css', array('pictau'));
}
add_action('wp_enqueue_scripts', 'pictau_child_enqueue_styles');
